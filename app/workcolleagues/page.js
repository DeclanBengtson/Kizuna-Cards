...
const WorkColleagues = () => {
  ...
  const cardStyles = "font-titanOne font-bold text-3xl text-blue-500";

  return (
    <div className="relative h-screen w-full overflow-hidden">
      {/* Animated gradient background */}
      <div className="absolute inset-0 bg-gradient-to-br from-sky-100 via-cyan-100 to-blue-200 animate-gradient-xy" />
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-3/4 left-1/3 w-96 h-96 bg-sky-200 rounded-full mix-blend-multiply filter blur-xl animate-float-delay-2 opacity-40" />
        ...
        <div className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-sky-300 rounded-full mix-blend-multiply filter blur-xl animate-float-delay-4 opacity-30" />
        <div className="absolute top-1/2 left-1/2 w-60 h-60 bg-cyan-100 rounded-full mix-blend-multiply filter blur-xl animate-float opacity-40" />
      </div>
